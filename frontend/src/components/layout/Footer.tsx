    ...
    <footer className="footer-root">
      <div className="footer-top">
        ...
        <div>
          ...
          {[
            ['Western Jewellery', '/products?category=cmp16bwkq0000xivjquaqr686'],
            ['Traditional', '/products?category=cmp16cd6z001pxivjnbjyijco'],
        ...
        <div>
          ...
          <a href="mailto:hello@shreejewels.com" className="footer-link">✉️ hello@shreejewels.com</a>
